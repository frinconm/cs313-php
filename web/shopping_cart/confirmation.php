...
<div class="container-fluid">
    <div class="row top-short-buffer">
        ...
        <div class="col-md-10"><h1>Confirmation</h1></div>
        <div class="col-md-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row top-buffer">
        ...
        <div class="col-md-2">
            <div id="shipping-wrapper">
                <h5>Shipping to:</h5>
                <b><?php echo $_POST["street_address1"]; ?><br>
                    <?php if (isset($_POST["street_address2"]) && (($_POST["street_address2"]) != ""))
                        echo $_POST["street_address2"] . "<br>"; ?>
                    <?php
                    echo $_POST["city"] . ", " . $_POST["state"] . " " . $_POST["zip"]; ?></b>
            </div>
        </div>
        <div class="col-md-4"></div>
    </div>
    ...
    <div class="row top-buffer">
        <div class="col-md-4"></div>
        <div class="col-md-4"><div class="alert alert-success alert-dismissible" role="alert">
